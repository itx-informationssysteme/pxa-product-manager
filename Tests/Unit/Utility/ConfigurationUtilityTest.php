...
class ConfigurationUtilityTest extends UnitTestCase
{
    ...
    {
        $this->assertEquals($this->getExtensionConfiguration(), ConfigurationUtility::getExtMgrConfiguration());
    }
    ...
    public function getExtSettingsReturnSettings()
    {
        ...
        $mockedConfigurationManager->expects($this->atLeastOnce())->method('isEnvironmentInFrontendMode')->willReturn(true);
        ...
        $this->assertEquals($this->getExtensionSettings()['settings'], ConfigurationUtility::getSettings());
    }
    ...
    public function readFromExtConfigurationByPathReturnValueOfSetting()
    {
        ...
        $this->assertEquals('value', ConfigurationUtility::getExtManagerConfigurationByPath($path));
    }
    ...
    public function readFromExtConfigurationByPathRecursiveReturnValueOfSetting()
    {
        ...
        $this->assertEquals(123, ConfigurationUtility::getExtManagerConfigurationByPath($path));
    }
    ...
    public function readFromSettingsByPathReturnValueOfSetting()
    {
        ...
        $this->assertEquals(123, ConfigurationUtility::getSettingsByPath($path));
    }
    ...
    public function readFromSettingsByPathNonExistingValueReturnNull()
    {
        ...
        $this->assertNull(ConfigurationUtility::getSettingsByPath($path));
    }
    ...
    public function readFromSettingsByPathRecursiveReturnValueOfSetting()
    {
        ...
        $this->assertEquals('testing', ConfigurationUtility::getSettingsByPath($path));

        $path = 'level1/level/setting';

        $this->assertEquals('value', ConfigurationUtility::getSettingsByPath($path));
    }
    ...
    public function readFromSettingsByPathRecursiveReturnSettings()
    {
        ...
        $this->assertEquals(['setting' => 'value'], ConfigurationUtility::getSettingsByPath($path));
    }
}
